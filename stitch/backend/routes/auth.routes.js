...
const { register, login, guestLogin, getProfile, verifyOtp, sendRegisterOtp, forgotPassword, resetPassword, getLeaderboard, updatePreferences } = require('../controllers/auth.controller');
